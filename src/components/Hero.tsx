      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 text-foreground leading-tight">
            Expertos en
            <span className="bg-gradient-to-r from-primary via-secondary to-primary bg-clip-text text-transparent"> Derecho de Salud </span>
            y Discapacidad
          </h1>
          
          <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
            Defendemos tus derechos con dedicación y profesionalismo. Asesoría especializada en incapacidades, pensiones y acceso a tratamientos médicos.
          </p>
