...
const CTA = () => {
  return (
    <section id="contacto" className="py-24 bg-gradient-to-br from-primary via-secondary to-primary relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-primary-foreground/90 mb-8 leading-relaxed">
            No dejes que el tiempo juegue en tu contra. Nuestro equipo está listo para evaluar tu caso y ofrecerte las mejores opciones legales.
          </p>
