        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-foreground">Lex Salud</h3>
                <p className="text-xs text-muted-foreground">Abogados Especialistas</p>
              </div>
            </div>
            <p className="text-muted-foreground text-sm leading-relaxed max-w-md">
              Despacho especializado en derecho sanitario y de la discapacidad. Más de 15 años defendiendo los derechos de nuestros clientes con profesionalismo y dedicación.
            </p>
          </div>
